      ...
      e.exports = function(e) {
        return new Promise(function(t, r) {
          ...
          e.socketPath
            ...
            : ((k.hostname = C.hostname), (k.port = C.port))
          var _,
            O = e.proxy
          if (!O && !1 !== O) {
            var A = b.slice(0, -1) + '_proxy',
          ...
          if (
            ...
            ((k.hostname = O.host),
            (k.host = O.host),
            (k.headers.host = C.hostname + (C.port ? ':' + C.port : '')),
            (k.port = O.port),
            (k.path =
              b + '//' + C.hostname + (C.port ? ':' + C.port : '') + k.path),
            O.auth)
          ) {
            var T = new Buffer(
    ...
    function(e, t, r) {
      ...
      t.handler = (function() {
        var e = (function(e) {
          ...
          if (
            ((t.callbackWaitsForEmptyEventLoop = !1),
            ...
            const n = {
              ...
              variables: {
                input: { lineItems: (t = JSON.parse(t.body)).items },
              },
            }
            let a
            try {
            ...
            if (t.hasAccount) {
              const e = {
                ...
                variables: {
                  input: { email: t.user.email, password: t.user.password },
                },
              }
              let n
              try {
              ...
              const c = {
                ...
                variables: { checkoutId: a.id, customerAccessToken: n },
              }
              try {
                ;(n = yield o({
                  url: 'https://lipslut2-0.myshopify.com/api/graphql',
