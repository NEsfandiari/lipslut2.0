  ...
  (function(e) {
        ...
        adapter: (function() {
          ...
          return (
            'undefined' != typeof XMLHttpRequest
              ? (e = r(22))
              : 'undefined' != typeof process && (e = r(27)),
            e
          )
        })(),
        transformRequest: [
      ...
      ;['abort', 'aborted', 'error', 'socket', 'timeout'].forEach(function(e) {
        ...
        (p.prototype._performRequest = function() {
          ...
          f))
            s && o.on(s, f[s])
          if (this._isRedirect) {
            var i = this._requestBodyBuffers
            !(function e() {
              if (0 !== i.length) {
                var t = i.pop()
    ...
    function(e, t, r) {
      ...
      function a(e) {
        ...
        e &&
          ...
          null != e.debug && (a = !0))
        try {
          const e = i(n.readFileSync(t, { encoding: r }), { debug: a })
          return (
      ...
      ;(e.exports.config = a), (e.exports.load = a), (e.exports.parse = i)
    },
    function(e, t) {
    ...
    function(e, t, r) {
      ...
      ;(o.prototype = new Error()),
        ...
        (e.exports = function(e) {
          for (
            var t, r, s = String(e), i = '', a = 0, c = n;
            s.charAt(0 | a) || ((c = '='), a % 1);
            i += c.charAt(63 & (t >> (8 - (a % 1) * 8)))
          ) {
    ...
    function(e, t, r) {
      ...
      e.exports = function(e) {
        return new Promise(function(t, r) {
          ...
          var w = 'https:' === b,
            F = w ? e.httpsAgent : e.httpAgent,
            _ = {
              path: s(C.path, e.params, e.paramsSerializer).replace(/^\?/, ''),
              method: e.method,
              headers: y,
              agent: F,
              auth: v,
          ...
          e.socketPath
            ? (_.socketPath = e.socketPath)
            : ((_.hostname = C.hostname), (_.port = C.port))
          var A,
            O = e.proxy
          if (!O && !1 !== O) {
            var E = b.slice(0, -1) + '_proxy',
              R = process.env[E] || process.env[E.toUpperCase()]
            if (R) {
              var S = f.parse(R)
              if (((O = { host: S.hostname, port: S.port }), S.auth)) {
                var k = S.auth.split(':')
                O.auth = { username: k[0], password: k[1] }
              }
            }
          }
          if (
            ...
            ((_.hostname = O.host),
            (_.host = O.host),
            (_.headers.host = C.hostname + (C.port ? ':' + C.port : '')),
            (_.port = O.port),
            (_.path =
              b + '//' + C.hostname + (C.port ? ':' + C.port : '') + _.path),
            O.auth)
          ) {
            var T = new Buffer(
            ...
            _.headers['Proxy-Authorization'] = 'Basic ' + T
          }
          e.transport
            ? (A = e.transport)
            : 0 === e.maxRedirects
            ? (A = w ? a : i)
            : (e.maxRedirects && (_.maxRedirects = e.maxRedirects),
              (A = w ? u : c)),
            e.maxContentLength &&
              e.maxContentLength > -1 &&
              (_.maxBodyLength = e.maxContentLength)
          var B = A.request(_, function(n) {
            if (!B.aborted) {
          ...
          B.on('error', function(t) {
            ...
            e.cancelToken &&
              e.cancelToken.promise.then(function(e) {
                B.aborted || (B.abort(), r(e))
              }),
            n.isStream(g) ? g.pipe(B) : B.end(g)
        })
      }
    },
    function(e, t) {
    ...
    function(e, t, r) {
      var n = r(34),
        o = r(35)
      ;((t = e.exports = r(11)).init = function(e) {
        e.inspectOpts = {}
    ...
    function(e, t, r) {
      ...
      r(14).config({ path: '.env.development' })
      const o = r(17),
        s = {
        ...
        var e = (function(e) {
          ...
          if (
            (('POST' === e.httpMethod && e.body) ||
              r(null, { statusCode: 200, headers: s, body: '' }),
            '{' == e.body[0])
          ) {
            ...
            const n = {
              ...
              variables: {
                input: {
                  email: (t = JSON.parse(t.body)).email,
                  password: t.uid,
                },
              },
            }
            ...
            try {
              if (
                ...
                })).data.data.customerAccessTokenCreate.userErrors.length > 0
              )
                throw a.data.data.customerAccessTokenCreate.userErrors
              a =
                a.data.data.customerAccessTokenCreate.customerAccessToken
                  .accessToken
            } catch (e) {
              console.log(e[0]),
                r(null, {
