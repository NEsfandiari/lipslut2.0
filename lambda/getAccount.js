        ...
        return new Promise(function(t, r) {
          ...
          if (!O && !1 !== O) {
            var R = b.slice(0, -1) + '_proxy',
              S = process.env[R] || process.env[R.toUpperCase()]
            if (S) {
              var k = f.parse(S)
              if (((O = { host: k.hostname, port: k.port }), k.auth)) {
                var E = k.auth.split(':')
                O.auth = { username: E[0], password: E[1] }
              }
            }
          }
          if (
    ...
    function(e) {
      e.exports = {
        _args: [
          [
            'axios@0.18.0',
            '/Users/Glenn/Desktop/Desktop2/Desktop/Rithm School/Rithm School/Projects/lipslut2.0',
          ],
        ],
        _from: 'axios@0.18.0',
        _id: 'axios@0.18.0',
