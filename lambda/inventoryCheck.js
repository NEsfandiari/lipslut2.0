      ...
      e.exports = function(e) {
        return new Promise(function(t, r) {
          ...
          var R,
            E = e.proxy
          if (!E && !1 !== E) {
            var O = x.slice(0, -1) + '_proxy',
              B = process.env[O] || process.env[O.toUpperCase()]
            if (B) {
              var A = f.parse(B)
              if (((E = { host: A.hostname, port: A.port }), A.auth)) {
                var j = A.auth.split(':')
                E.auth = { username: j[0], password: j[1] }
              }
            }
          }
          if (
            ...
            _.headers['Proxy-Authorization'] = 'Basic ' + S
          }
          e.transport
            ? (R = e.transport)
            : 0 === e.maxRedirects
    ...
    function(e, t, r) {
      ...
      t.handler = (function() {
        var e = (function(e) {
          ...
          if (0 === JSON.parse(e.body).available)
            try {
              yield o.post(
