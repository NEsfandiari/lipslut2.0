      ...
      e.exports = function(e) {
        return new Promise(function(t, r) {
          ...
          var O,
            R = e.proxy
          if (!R && !1 !== R) {
            var E = x.slice(0, -1) + '_proxy',
              S = process.env[E] || process.env[E.toUpperCase()]
            if (S) {
              var A = f.parse(S)
              if (((R = { host: A.hostname, port: A.port }), A.auth)) {
                var B = A.auth.split(':')
                R.auth = { username: B[0], password: B[1] }
              }
            }
          }
          if (
            ...
            (_.port = R.port),
            (_.path =
              x + '//' + C.hostname + (C.port ? ':' + C.port : '') + _.path),
            R.auth)
          ) {
            var j = new Buffer(
            ...
            _.headers['Proxy-Authorization'] = 'Basic ' + j
          }
          e.transport
            ? (O = e.transport)
            : 0 === e.maxRedirects
        ...
        var e = (function(e) {
          ...
          if (
            ...
            try {
              ...
              ;(e = e.data.errors ? e.data.errors : e.data.data.customerCreate),
                r(null, {
                  statusCode: 200,
                  headers: s,
